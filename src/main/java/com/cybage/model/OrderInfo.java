...
public class OrderInfo
{
	...
	public OrderInfo(String id2, Date orderDate2, int orderNum2, double amount2, String customerName2,
			String customerAddress2, String customerEmail2, String customerPhone2) {
